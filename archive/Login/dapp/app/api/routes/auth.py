...
def _auth_settings() -> dict[str, str]:
    ...
    image_auth_env = _read_env_file(repo_root / "image-auth" / ".env.local")

    return {
      "APP_AUTH_SECRET": os.getenv("APP_AUTH_SECRET") or dapp_env.get("APP_AUTH_SECRET") or image_auth_env.get("JWT_SECRET", ""),
      "SMTP_HOST": os.getenv("SMTP_HOST") or dapp_env.get("SMTP_HOST") or ("smtp.gmail.com" if image_auth_env.get("EMAIL_USER") else ""),
      "SMTP_PORT": os.getenv("SMTP_PORT") or dapp_env.get("SMTP_PORT") or "587",
      "SMTP_USERNAME": os.getenv("SMTP_USERNAME") or dapp_env.get("SMTP_USERNAME") or image_auth_env.get("EMAIL_USER", ""),
      "SMTP_PASSWORD": os.getenv("SMTP_PASSWORD") or dapp_env.get("SMTP_PASSWORD") or image_auth_env.get("EMAIL_PASS", ""),
      "SMTP_FROM_EMAIL": os.getenv("SMTP_FROM_EMAIL") or dapp_env.get("SMTP_FROM_EMAIL") or image_auth_env.get("EMAIL_USER", ""),
