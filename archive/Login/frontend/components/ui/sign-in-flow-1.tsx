...
export const SignInPage = ({ className, onSuccess, onGoogleSignIn, googleButtonLabel }: SignInPageProps) => {
  ...
  return (
    <div className={cn("relative flex min-h-screen w-full flex-col overflow-hidden bg-surface text-on-surface", className)}>
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      <button
                        ...
                        className="flex w-full items-center justify-center gap-2 rounded-full border border-outline-variant bg-surface-container-low px-4 py-3 text-on-surface transition-colors hover:border-primary/35 hover:bg-surface-container"
                      >
